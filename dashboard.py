...
def save_status_json():
    ...
    if active_trade:
        ...
        status["active_trade"] = {
            ...
            "score": active_trade.get('score')  # Ajout du score dans le status
        }
            ...
            with open(STATUS_FILE, 'r') as f:
                ...
                if saved_trade:
                    saved_flags = {
                        ...
                        "score": saved_trade.get("score")  # Ajout
                    }
        except Exception as e:
            ...
            if long_units != 0 or short_units != 0:
                ...
                if open_trades:
                    ...
                    active_trade = {
                        ...
                        'score': saved_flags.get("score")  # Ajout
                    }
...
def main():
    ...
    try:
        while True:
            ...
            # Mise à jour du sentiment (Finnhub)
...
# ---------- NOUVELLE FONCTION PLACE_TRADE (avec score) ----------
def place_trade(instrument, entry_price_signal, sl_signal, tp_signal, direction, setup_type, risk_percent, reason, df, balance):
    ...
    # Recalcul SL/TP avec le prix actuel
    config = PAIR_CONFIG[instrument]
    ...
    # Extraction du score depuis la raison
    import re
    ...
    try:
        ...
        active_trade = {
            ...
            'score': score_value  # <-- AJOUT du score
        }
    except Exception as e:
    ...
    msg = (f"<b>✅ Trade opened ({trades_today}/{MAX_TRADES_PER_DAY})</b>\n"
           ...
           f"TP2: {new_tp:.5f} (2R)\n"
           f"R/R: 1:2\n"
           f"Quality score: {score_value if score_value is not None else 'N/A'}\n"
...
# ---------- Fonction check_closed_trade (avec score) ----------
def check_closed_trade():
    ...
    try:
        ...
        score = active_trade.get('score')  # Récupération du score
